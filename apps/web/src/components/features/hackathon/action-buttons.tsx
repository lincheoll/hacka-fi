    ...
    <div className={cn("space-y-4", className)}>
      ...
      {actions.canRegister.allowed && !isRegistered && userAddress && (
        <div className="space-y-2">
          ...
          {actions.timeData.timeRemaining &&
            actions.timeData.timeRemaining < 24 * 60 * 60 * 1000 && (
      ...
      {isJudge &&
        ...
        actions.statusInfo.status === "VOTING_OPEN" && (
          <Alert className="border-blue-500 bg-blue-50">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              You are a judge for this hackathon. Voting will be available when
      ...
      {!isJudge &&
        ...
        actions.statusInfo.status === "VOTING_OPEN" && (
          <Alert className="border-gray-500 bg-gray-50">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              Voting is currently open. Only approved judges can vote on
      ...
      {actions.statusInfo.isCompleted && (
        <div className="space-y-2">
          <Alert className="border-green-500 bg-green-50">
            <AlertDescription>
              This hackathon has been completed. View the results to see
              winners!
            </AlertDescription>
          </Alert>
          ...
          <Button
            ...
            className="w-full"
            onClick={() =>
              (window.location.href = `/hackathons/${hackathon.id}/results`)
            }
          >
